...
power_enable = machine.Signal(18, machine.Pin.OUT, None, invert=False)
# ========== configuration options ==========
...
def deinit_pins():
    ...
    sdata.init(machine.Pin.IN, None)
    sclk.init(machine.Pin.IN, None)
    xres.init(machine.Pin.IN, None)
...
def _on_callback(t):
    sclk(1)
    t.deinit()
    t.init(freq=50000, callback=_off_callback)
